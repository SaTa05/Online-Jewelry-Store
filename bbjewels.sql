...
(0003, 0037, 10, 0002, 'y', '2022-12-21 02:27:03', '2022-12-21', 218063009),
(0004, 0015, 2, 0003, 'y', '2022-12-21 05:02:42', '2022-12-21', 62008622),
(0005, 0076, 7, 0003, 'y', '2022-12-21 06:08:24', '2022-12-21', 1233453905),
(0007, 0111, 2, 0003, 'y', '2022-12-21 06:19:16', '2022-12-21', 883666370);
...
INSERT INTO `contact` (`s_no`, `name`, `email`, `phone`, `description`, `datetime`) VALUES
(9, 'SHOUBHIT KUMAR', 'shoubhitkumaraps.1234@gmail.com', '564554648', 'jghadafsafsdf', '2022-12-21 15:58:54');
...
(0002, 'Diamond/Bangles/2.jpg', 'Diamond/Bangles/2.jpg', 1, '3000.00', 'Diamond Carte:20', 'featured', 13, 27),
...
(0076, 'Gold/Bangles/1.jpg', 'Gold/Bangles/1.jpg', 9, '1000.00', 'Gold Carte:24', 'soon', 1, 0),
(0026, 'Diamond/Lady Ring/1.jpg', 'Diamond/Lady Ring/1.jpg', 8, '1000.00', 'Diamond Carte:20', 'latest', 7, 14),
...
(0030, 'Diamond/Lady Ring/5.jpg', 'Diamond/Lady Ring/5.jpg', 8, '1000.00', 'Diamond Carte:18Gold Carte: 24', 'featured', 2, 0),
...
(0037, 'Diamond/Necklaces/2.jpg', 'Diamond/Necklaces/2.jpg', 3, '1000.00', 'Diamond Carte:15', 'featured', 1, 0),
...
(0111, 'Gold/Man Rings/2.jpg', 'Gold/Man Rings/2.jpg', 36, '1799.00', 'Gold Carte:24', 'featured', 1, 0),
...
(0161, 'Gold/Pendant Set/6.jpg', 'Gold/Pendant Set/6.jpg', 15, '375.00', 'Gold Carte: 24', 'featured', 1, 0),
...
(0233, 'Silver/Chain/9.jpg', 'Silver/Chain/9.jpg', 28, '1000.00', 'Pure Silver', 'featured', 1, 0),
...
(0001, 9, 'Bangles', 'viewproduct.php'),
(0002, 3, 'EarRings', 'viewproduct.php'),
...
(0003, 'Mohit', 'Vora', 'mohit', 'mohit', 'm@g.clouj', 'awdytafdaf aghdftyad sagfdyuasd adgasfdguad adfaud', 58888888, 'user', 1),
(0004, 'asjkdg', 'khyj', 'ugyu', '123456', 'hfhg@hsvd.asdjg', 'kagdjh dahgdah dasndghd dsagdasd jgjgj', 2147483647, 'user', 1);
...
(0001, '   CP Jewellery Online Store has more than 35 years of experience in dealing with jewelleries susch as Gold, Silver and Diamond.', 'about');
...
--
ALTER TABLE `contact`
  MODIFY `s_no` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `main_menu`
  MODIFY `mmenu_id` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
