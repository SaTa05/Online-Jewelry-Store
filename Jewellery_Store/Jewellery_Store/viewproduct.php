				...
				<div class="box-content-1">
					<div class="box-product-1" >
						<?php
							...
							$sql = "SELECT COUNT(*) FROM main_menu m, sub_menu sm, jewellery jw where m.mmenu_id = sm.mmenu_id and jw.category = sm.id and jw.category = $item";
